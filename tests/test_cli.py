...
"""
    ...
    def test_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('SPARK_CLI_RELEASE_NAME="${SPARK_CLI_RELEASE_NAME:-spark-cli-launch-2026-04-29-2}"', script)
        self.assertIn('SPARK_DEFAULT_CLI_REF="428b3ead181c4acba2e2da4aa9fee17b072175a0"', script)
    ...
    def test_windows_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('[string]$Ref = "428b3ead181c4acba2e2da4aa9fee17b072175a0"', script)
        self.assertIn('$SparkCliReleaseName = "spark-cli-launch-2026-04-29-2"', script)
