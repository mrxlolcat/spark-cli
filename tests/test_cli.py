...
"""
    ...
    def test_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('SPARK_DEFAULT_CLI_REF="spark-cli-launch-2026-04-27"', script)
        ...
        self.assertIn("trap 'cleanup_secret_files' EXIT HUP INT TERM", script)
        ...
        self.assertIn("require_python_version", script)
    ...
    def test_windows_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('[string]$Ref = "spark-cli-launch-2026-04-27"', script)
        ...
        self.assertIn("Require-PythonVersion", script)
        self.assertIn("Python >= 3.11 is required for Spark", script)
