...
class SparkCliTests(unittest.TestCase):
    ...
    def test_guide_advanced_prints_expert_surface(self) -> None:
        ...
        self.assertIn("Codex sign-in", output)
...
"""
    ...
    def test_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('SPARK_CLI_RELEASE_NAME="${SPARK_CLI_RELEASE_NAME:-spark-cli-launch-2026-04-27-3}"', script)
        self.assertIn('SPARK_DEFAULT_CLI_REF="d8081962d1b788da4c23ced3ca86cc912e363c87"', script)
    ...
    def test_windows_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('[string]$Ref = "d8081962d1b788da4c23ced3ca86cc912e363c87"', script)
        self.assertIn('$SparkCliReleaseName = "spark-cli-launch-2026-04-27-3"', script)
